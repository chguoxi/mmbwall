...
<div class="content">
	<div class="new_box">
		<a href="<?php echo site_url()?>">首页</a><span>></span>
	...
	<div class="nr_wz">
		<article>
			...
			<?php endif;?>
			<?php if (isset($node->body_part_1)):?>
			<section class="wz_font16"><?php echo $node->body_part_1?></section>
			<section class="wz_font16" id="body_part_2"><?php echo $node->body_part_2?></section>
			<section class="button1" style="padding-top: 10px;" id="show_more_btn">
				<a href="javascript:void(0)"><img src="<?php echo $common_theme_path?>images/button6.gif" width="219" height="46"></a>
			</section>
			<?php else :?>
	...
	<div class="box">
		...
		<section class="box_pl" style="margin-top:0;">
			<?php $this->load->view(SITE_LANG.'/block/sina_t_comment')?>
		</section>	
	</div>
